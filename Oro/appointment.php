            ...
            if(mysqli_num_rows($result)>0){
              while($row = mysqli_fetch_assoc($result)){
                ...
                echo '
                    ...
                    <td>'.$row['contact'].'</td>
                    <td>
                        <a href="update_appointment.php?a_u_id='.$row['appointment_id'].'" class="btn btn-warning btn-sm">Update</a>
                        <a href="ap_action.php?a_d_id='.$row['appointment_id'].'" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                  </tr>
