...
<body>
  ...
  <div class="admin-port">
    ...
    <form action="checklogin.php" method="POST" class="py-5 ap-form">

        <div class="ap d-flex justify-content-center">
        <div class="fields d-md-block text-center">
  
          <div class="segment">
            <label for="user">Username</label>
            <input placeholder="Username" type="text" id="user" name="user" class="form-control">
          </div>

        <br>
          <div class="segment">
            <label for="pass">Password</label>
            <input placeholder="Password" type="password" id="pass" name="pass" class="form-control">
          </div>
        </div>
      </div>

  
        <div class="sub-btn text-center mt-4">
